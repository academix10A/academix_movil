...
//     final esta = await _vm.estaGuardado(widget.recurso['id_recurso'] as int);
...
//     try {
//       await _vm.guardar(widget.recurso);
...
//     try {
//       await _vm.eliminar(
//         widget.recurso['id_recurso'] as int,
//         widget.recurso['url_archivo'] as String?,
//       );

...
class SelectResourceBottomSheet extends StatefulWidget {
  ...
  static void show(
    ...
    int? preselectedId,
    required void Function(int, String) onSelected,
  }) {
  ...
  @override
  State<SelectResourceBottomSheet> createState() =>
      _SelectResourceBottomSheetState();
}

class _SelectResourceBottomSheetState
    extends State<SelectResourceBottomSheet> {
  ...
  void _filterResources() {
    // filtering is handled by LibraryViewModel internally if extended
  }
          ...
          children: [
            ...
            Expanded(
              child: vm == null
                  ...
                  : ValueListenableBuilder<List<LibraryResource>>(
                      ...
                      builder: (context, resources, _) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final isSelected =
                                widget.preselectedId != null &&
                                    resource.id ==
                                        widget.preselectedId.toString();
                            return GestureDetector(
                              onTap: () {
                                widget.onResourceSelected(
                                    int.parse(resource.id), resource.title);

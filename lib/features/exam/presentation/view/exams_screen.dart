...
/// Pantalla principal de exámenes.
/// 
/// Solo maneja UI. Toda la lógica vive en [ExamsViewModel].
...
class _ExamsScreenState extends State<ExamsScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (!_initialized) {
      vm = ExamsViewModel(
        getAvailableExams: context.examDependencies.getAvailableExamsUseCase,
        getDetailedExams: context.examDependencies.getDetailedExamsUseCase,
      );
      _initialized = true;
    }
  }
        ...
        children: [
          Text(
            ...
            style: AppTextStyles.display
                .copyWith(fontSize: 28, letterSpacing: 1.5, color: AppColors.primary),
          ),
          ...
          ValueListenableBuilder<List<String>>(
            ...
            builder: (context, subtemas, _) {
              ...
              return ValueListenableBuilder<String?>(
                ...
                builder: (context, selectedSub, _) => SizedBox(
                  height: 36,
                  child: ListView(
...
class _AvailableSection extends StatelessWidget {
  ...
  const _AvailableSection({required this.vm});

  @override
  Widget build(BuildContext context) {
    return ValueListenableBuilder<List<ExamItemModel>>(
...
class _CompletedSection extends StatelessWidget {
  ...
  const _CompletedSection({required this.vm});
      ...
      builder: (context, filter, _) {
        ...
        return ValueListenableBuilder<bool>(
          ...
          builder: (context, noPermiso, _) {
            ...
            return ValueListenableBuilder<List<CompletedExamItemModel>>(
              ...
              builder: (context, exams, _) {
                      ...
                      child: Column(
                        children: [
                          Icon(Icons.check_circle_outline,
                              size: 48, color: AppColors.textMuted),
                          const SizedBox(height: AppSpacing.md),
                          Text('Aún no has completado exámenes',
                              style: AppTextStyles.body
                                  .copyWith(color: AppColors.textMuted)),
                        ],
                      ),
                ...
                return Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Completados recientemente',
                        style:
                            AppTextStyles.h2.copyWith(color: AppColors.text)),
                    const SizedBox(height: AppSpacing.md),
                    ...exams.map((exam) => Padding(
                          padding:

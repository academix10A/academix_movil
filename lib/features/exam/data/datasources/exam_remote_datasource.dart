...
/// Fuente de datos remota: responsable únicamente de hacer llamadas HTTP
/// y mapear la respuesta cruda a entidades del dominio.
/// 
/// No contiene lógica de negocio. No llama a otros datasources.
class ExamRemoteDataSource {
  ...
  /// Lanza [DioException] con status 403 si el usuario no tiene el beneficio HISTORIAL.
